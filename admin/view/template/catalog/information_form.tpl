                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group required">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="list_title">Заголовок</label>
                        <div class="col-sm-10">
                            <?php if($information_description[$language['language_id']]['list_title']):?>
                            <input id="list_title" type="checkbox" name="list_title" value="true" checked>
                            <?php else: ?>
                            <input id="list_title" type="checkbox" name="list_title" value="true">
                            <?php endif ?>
                        </div>
                    </div>
                  <div class="form-group">
