<div id="cart" class="btn-group btn-block">
  <button type="button" data-toggle="dropdown" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-link btn-block btn-sm dropdown-toggle"><i style="color: #006341;font-size: 20px" class="fa fa-shopping-cart"> <span style="font-size: 13px;"><?php echo $text_items; ?> <span class="caret"></span></span></i></button>
